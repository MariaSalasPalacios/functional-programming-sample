package ti.techacademy.fp.sample.stream;

import ti.techacademy.fp.sample.repository.OfferrRepository;
import ti.techacademy.fp.sample.builder.Offer;
import ti.techacademy.fp.sample.builder.OfferDto;
